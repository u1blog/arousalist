...
export const EXPERIENCES = [
...

  {
    ...
    instructions: [
      ...
      },
      {
        type: 'partner',
        label: 'With a partner (the real version)',
        content: "Receiver is blindfolded. Giver moves through textures and body areas without pattern or announcement — the receiver doesn't know what material is coming, which part of the body will be touched next, or how firmly. The brain, unable to predict, stays completely present. After one round, switch roles. Choosing which texture to apply where, reading the receiver's response, and deciding when to change — the giver's experience of orchestrating this is genuinely different from receiving it.",
      },
    ],
    explore: [
...

  {
    ...
    tier: 'better-with-partner',
    category: 'sensation',
    description: 'Discover what sustained loss of sight does to your mental state — whether the darkness feels calming, disorienting, or something you want more of.',
    ratingTypes: ['solo', 'receiver', 'giver'],
    ...
    instructions: [
      ...
      {
        type: 'partner',
        label: 'With a partner (where it gets interesting)',
        content: "Receiver puts on the blindfold and keeps it on for the duration. The giver becomes the receiver's only point of reference. Lead them slowly to different positions — sitting, lying, standing — without explaining what's coming next. Let silences stretch. Introduce occasional light touch without warning, then withdraw. The point isn't to administer sensations; it's to manage someone's entire sensory environment. The receiver's job is to stay in the disorientation and notice what that sustained state produces. After one round, switch roles — being the one who holds someone else's orientation is a very different experience.",
      },
    ],
    explore: [
...

  {
    ...
    safetyNote: 'Strike only fleshy areas — outer thighs and buttocks are the standard starting zones. Never strike the lower back (kidneys), spine, joints, tailbone, or head. Build from very light to moderate; there\'s no reason to start at intensity. Agree on a clear signal to pause before you begin.',
    instructions: [
      {
        type: 'solo',
        label: 'Solo first',
...

  {
    ...
    safetyNote: 'Never restrain around the neck. Use loose, quick-release knots — not slipknots that tighten under tension. Keep scissors nearby if using fabric or rope. Never leave a restrained person unattended. Agree on a clear signal to stop before you begin.',
    instructions: [
      {
        type: 'solo',
        label: 'Solo first',
...

  {
    ...
    safetyNote: 'Gather hair from close to the scalp — pulling from the ends yanks on individual strands and causes discomfort without the intended sensation. Apply steady tension rather than sharp jerks. Check in about pressure as you build.',
    instructions: [
      {
        type: 'single',
        label: 'With a partner',
        content: "Gather a good handful of hair close to the scalp — pulling from the ends is uncomfortable and damages hair; pulling from the root is the sensation. Apply slow, steady upward or backward tension — not a jerk. Vary the pressure from very light (just feeling the roots engage) to more assertive. Try combining with restraint — head pulled back, neck exposed. After one round, switch roles — the positional control and the sensation of being controlled are genuinely different experiences.",
      },
    ],
    explore: [
...

  {
    ...
    safetyNote: 'Keep nails reasonably clean. Avoid scratching over broken skin, rashes, or moles. Avoid the face. Build pressure gradually — it\'s easy to misjudge how a firm drag feels to someone else.',
    instructions: [
      {
        type: 'single',
        label: 'With a partner',
...

  {
    ...
    safetyNote: 'Avoid bony areas — spine, collarbone, ribs. Never bite hard enough to break skin. Build pressure very gradually and watch the receiver\'s response closely; intensity that feels controlled to the giver can feel sharper than expected to the receiver.',
    instructions: [
      {
        type: 'single',
        label: 'With a partner',
